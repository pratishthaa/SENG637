...
In this Lab we worked to make the first bug report for the given SUT, here being the two versions of the ATM(v1.0 vs v1.1) application. This bug report will consist of 2 aproaches or techniques.
