...
In order to perform white-box analysis, 
...
We did not encounter challenges in this project as all of us were familiarised with the system under the test (SUT).
