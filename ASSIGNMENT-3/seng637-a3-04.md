...
`org.jfree.data.DataUtilities` : calculateColumnTotal, calculateRowTotal, getCumulativePercentages, createNumberArray, createNumberArray2D

and `org.jfree.data.Range` : intersects, combine, expandToInclude, contains, getCentralValue
